(function ($) {
	...
	$('.bitcoin-button').each(function () {
	    ...
	    div.append('<div class="bitcoin-bubble" style="display:hidden;"><div><strong>Bitcoin address</strong></div><img src="http://chart.googleapis.com/chart?chs=200x200&cht=qr&chld=H|0&chl='+encodeURIComponent(url)+'" width="200" height="200" alt="QR code"/><div><a href="'+url+'">'+address+'</a></div></div>');
